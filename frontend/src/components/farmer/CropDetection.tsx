        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                <div className="space-y-8">
                    <div className="relative p-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-white/10 shadow-2xl rounded-[2.5rem] overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <div
                                className={`relative aspect-video rounded-3xl border-2 border-dashed transition-all duration-500 flex flex-col items-center justify-center overflow-hidden cursor-pointer ${preview ? 'border-green-500/50 bg-black/40' : 'border-white/10 hover:border-white/30 bg-white/5'}`}
                            ...
                            >
                                {preview ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center p-12">
                                        <div className="w-20 h-20 bg-white/5 border border-white/10 rounded-3xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                    ...
                    {/* ===== AI RESULT PANEL ===== */}
                    {result && (
                        <div className="bg-white/5 backdrop-blur-xl p-7 rounded-[2.5rem] border border-white/10 shadow-2xl animate-scale-in">
                            <div className="flex items-center justify-between mb-6">
                ...
                <div className="space-y-8">
                    {showForm ? (
                        <div className="bg-white/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/10 shadow-2xl animate-fade-in">
                            {submitSuccess ? (
                                    ...
                                    <form onSubmit={handleAddListing} className="space-y-5">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <select required className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 px-4 text-sm font-bold text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all appearance-none" value={formData.cropName} onChange={e => setFormData({ ...formData, cropName: e.target.value })}>
                                            ...
                                            <div>
                                                ...
                                                <input className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 px-4 text-sm font-bold text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all placeholder:text-white/20" placeholder="e.g. Sharbati, 1121..." value={formData.variety} onChange={e => setFormData({ ...formData, variety: e.target.value })} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input required type="number" className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 pl-12 pr-4 text-sm font-bold text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all placeholder:text-white/20" placeholder="500" value={formData.quantity} onChange={e => setFormData({ ...formData, quantity: e.target.value })} />
                                                </div>
                                            </div>
                                            <div>
                                                <label className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-1.5 block">Unit</label>
                                                <select className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 px-4 text-sm font-bold text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all appearance-none" value={formData.unit} onChange={e => setFormData({ ...formData, unit: e.target.value })}>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input required type="number" className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 pl-12 pr-4 text-sm font-bold text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all placeholder:text-white/20" placeholder="2450" value={formData.expectedPrice} onChange={e => setFormData({ ...formData, expectedPrice: e.target.value })} />
                                                </div>
                                            </div>
                                            <div>
                                                <label className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-1.5 block">Quality Grade</label>
                                                <select className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 px-4 text-sm font-bold text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all appearance-none" value={formData.quality} onChange={e => setFormData({ ...formData, quality: e.target.value })}>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <textarea className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 pl-12 pr-4 text-sm font-bold text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all placeholder:text-white/20 resize-none h-20" placeholder="Organic, freshly harvested, no pesticides..." value={formData.description} onChange={e => setFormData({ ...formData, description: e.target.value })} />
                                            </div>
                                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-7 bg-gradient-to-br from-emerald-900/40 to-green-900/20 rounded-[2.5rem] border border-emerald-500/20 relative overflow-hidden group">
                            ...
                            <div className="space-y-4 max-h-[650px] overflow-y-auto pr-2 custom-scrollbar">
                                {listings.length === 0 ? (
                                    ...
                                    listings.map((item) => (
                                        <div key={item._id} className="group bg-white/5 rounded-[2rem] border border-white/10 shadow-sm hover:shadow-2xl hover:border-emerald-500/20 transition-all overflow-hidden">
                                            {/* Image Banner */}
                                            {item.image && (
                    ...
                    <div className="p-7 bg-gradient-to-br from-emerald-900/40 to-green-900/20 rounded-[2.5rem] border border-emerald-500/10 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-500/10 rounded-full blur-3xl -mr-24 -mt-24 group-hover:bg-emerald-500/20 transition-all duration-1000"></div>
                        <div className="relative z-10">
